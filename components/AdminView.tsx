                ...
                {activeTab === 'dashboard' && (
                    <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100"><p className="text-gray-400 text-xs font-bold uppercase tracking-wider mb-2">Workers</p><div className="flex items-end justify-between"><h3 className="text-3xl font-serif font-bold text-charcoal">{stats.workersCount}</h3><UsersIcon className="w-8 h-8 text-gold-leaf opacity-20" /></div></div>
