...
export const PricingView: React.FC<PricingViewProps> = ({ 
  ...
  const setOrderCreatingFlag = () => {
      ...
      orderCreationTimerRef.current = setTimeout(() => {
  ...
  return (
    ...
    <div ref={ticketRef} className="printable-area printable-ticket" data-print-type="ticket" style={{ position: 'absolute', left: '-9999px', width: '400px', margin: '0 auto', padding: '20px', backgroundColor: 'white', color: 'black' }}>
    ...
    <div id="printable-bill-area" ref={receiptRef} className="printable-area printable-bill" data-print-type="bill" style={{ position: 'absolute', left: '-9999px', width: '500px', padding: '40px', backgroundColor: 'white', color: 'black', fontFamily: 'serif', boxSizing: 'border-box' }}>
