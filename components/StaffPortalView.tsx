                ...
                {activeTab === 'profile' && (
                    <>
                        <div className="text-center relative">
                            <div className="w-28 h-28 mx-auto rounded-full border-4 border-gold-leaf shadow-lg overflow-hidden bg-gray-200 relative group">
                                {avatar ? (
                                    <img src={avatar} alt="Me" className="w-full h-full object-cover" />
                                ) : (
                                    <div className="w-12 h-12 text-gray-400 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
